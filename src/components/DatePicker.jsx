...
function ClearLogo(clearable) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M15.3975 9.3975L12.795 12L15.3975 14.6025C15.4528 14.654 15.4971 14.7161 15.5278 14.7851C15.5586 14.8541 15.5751 14.9286 15.5764 15.0041C15.5778 15.0796 15.5639 15.1547 15.5356 15.2247C15.5073 15.2947 15.4652 15.3584 15.4118 15.4118C15.3584 15.4652 15.2947 15.5073 15.2247
...
export default function DatePicker({ dates }) {
  ...
  return (
    <div className="width-[320px] max-w-[360px] min-w-[320px]">
      <Suspense>
        <DateRangePicker portalContainer={null} showLeadingZeros={true} calendarClassName='calendar' className='date_picker' onChange={onSelectDates} rangeDivider={' to '} calendarIcon={<Image alt='calendar' src="/calendar.svg" width={16} height={16} />} value={dates} clearIcon={ClearLogo(clearable)} />
      </Suspense>
    </div>
  )
}
