  ...
  return (
      <div className='flex flex-col grow xl:grid xl:grid-cols-6 gap-4 min-w-[360px] mb-16'>
        ...
        <div className='xl:col-span-2'>
          ...
          title={<div className='flex space-x-2'><Image alt='recent' src={emergingIcon}/><span className='text-white font-bold space-x-0.5'>Emerging repos</span></div>} subtitle={`Top ${emerging_repos.length}`}/>
        </div>
        <div className='xl:col-span-2'>
          ...
          title={<div className='flex space-x-2'><Image alt='recent' src={refreshIcon}/><span className='text-white font-bold space-x-0.5'>Needing a refresh</span></div>} subtitle={`Top ${needing_refresh.length}`}/>
        </div>
        <div className='xl:col-span-2'>
          <PunchCard
            data={hot_packages}
