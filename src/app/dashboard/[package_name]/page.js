  ...
  return (
    <div>
      <header className='bg-neutral-800 shadow-lg border-b-2 border-neutral-725 sticky top-0 z-20 opacity-95 backdrop-filter backdrop-blur-xl bg-opacity-90 lg:h-[82px]'>
        <div className='mx-auto flex flex-col lg:flex-row lg:items-center justify-between py-2 lg:px-16 w-11/12 lg:w-full xl:w-11/12'>
          ...
          <div className='flex growxl:justify-end flex-col items-start md:flex-row lg:items-center gap-4 lg:ml-8 xl:ml-0 my-4 md:mt-4 md:mb-0 '>
            <Filter
              value={country_code}
              icon={
                <Image
